...
import { Megaphone, Flag, BarChart3, Users, UserCog } from "lucide-react";
...
function AdminIndex() {
  ...
  const [stats, setStats] = useState({ users: 0, videos: 0, reports: 0, announcements: 0 });
  ...
  const cards = [
    ...
    { to: "/admin/reports", label: "Open reports", icon: Flag, value: stats.reports, show: permissions.has("view_reports") },
